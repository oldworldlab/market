  ...
  return (
    <main className="container mx-auto px-4 py-8 flex-grow">
      <div className="text-center mb-12">
        ...
        <Button className="bg-[#ffd700] text-black hover:bg-[#ffed4a] interactive-button cursor-interactive">
          Begin Your Quest
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[ 
          ...
          <div key={card.title} className="bg-[#1c2333] border border-[#30363d] rounded-lg overflow-hidden glow-gold-hover cursor-interactive">
            <Image 
            ...
            <div className="p-4">
              ...
              <Button className="w-full bg-transparent border border-[#ffd700] text-[#ffd700] hover:bg-[#ffd700] hover:text-black interactive-button">
                Explore {card.title}
              </Button>
            </div>
          </div>
